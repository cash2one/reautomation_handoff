...
class Security(ConfigurationTest):
	...
	def test_ath_11035_try_editing_radius_erver_onfiguration(self):
		...
		security_page.create_authentication_server(name=conf.auth_rad1, ip=conf.auth_rad1_ip, sharedkey=conf.alpha_numeric, retypekey=conf.alpha_numeric, vlan=conf.valid_vlan_id_value)
		security_page.save_auth_server()
		security_page.click_edit_auth_server()
		security_page.create_authentication_server(vlan=conf.vlan_id_4093)
		security_page.save_auth_server()
		self.take_s2_snapshot()
		self.LeftPanel.go_to_network_page()
		self.NetworkPage.delete_network_if_present()
	...
	def test_ath_11031_verify_captive_portal_names_with_quotes(self):
		...
		security_page.create_new_captive_portal_1(name = '"')
		self.browser.assert_element(self.Captive_Name_splchars_error,'Captive portal name is accepting double qoutes')
		self.take_s2_snapshot()
		self.LeftPanel.go_to_network_page()
		self.NetworkPage.delete_network_if_present()
		self.take_s3_snapshot()
