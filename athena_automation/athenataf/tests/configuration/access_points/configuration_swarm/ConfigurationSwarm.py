...
class ConfigurationSwarm(AthenaGUITestCase):
	'''
	...
	def test_ath_11237_configure_access_points_parameters_swarm_level(self):
		self.take_s1_snapshot("show_ip_interface_brief")
		conf = self.config.config_vars
		inner_left_panel = self.TopPanel.click_slider_icon()
		...
		access_point.select_particular_vc('IAP_1')
		access_point.get_and_set_slave_iap_details()
		access_point.save_settings()
		access_point.reboot_popup_ok.click()
		self.take_s2_snapshot("show_ip_interface_brief")
		access_point.select_particular_vc('IAP_1')
		access_point.get_ip_from_dhcp.click()
		access_point.save_settings()
		access_point.reboot_popup_ok.click()
		self.take_s3_snapshot('show_ip_interface_brief')
		self.assert_s1_s2_diff(None)
		self.assert_s1_s3_diff()
		self.clear()
