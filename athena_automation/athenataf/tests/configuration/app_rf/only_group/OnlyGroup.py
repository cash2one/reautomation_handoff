...
class OnlyGroup(ConfigurationTest):
	...
	def test_ath_13345_check_app_rf_rule_created_under_role_based_network(self):
		...
		security_page.clicking_on_role_accordion()
	...
	def test_ath_6125_import_config_from_iap(self):
		conf = self.config.config_vars
		self.TopPanel.import_device()
		self.InnerLeftPanel.select_unprovision_iap()
